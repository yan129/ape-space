...
public class ThemeController {
    ...
    @PostMapping("/create")
    public ResultVO<String> createTheme(@RequestBody @Valid ThemeDO themeDO){
        themeService.save(themeDO);
        return ResultVO.OK("专题新建成功");
    }
    ...
    public ResultVO<String> deleteTheme(@ApiParam("专题ID") @RequestParam("id") String id,
        ...
        return result ? ResultVO.OK("专题删除成功") : ResultVO.ERROR("专题删除失败");
    }
